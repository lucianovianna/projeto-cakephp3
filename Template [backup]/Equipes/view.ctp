...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Editar Equipe'), ['action' => 'edit', $equipe->equipe_id]) ?> </li>
        <li><?= $this->Form->postLink(__('Deletar Equipe'), ['action' => 'delete', $equipe->equipe_id], ['confirm' => __('Are you sure you want to delete # {0}?', $equipe->equipe_id)]) ?> </li>
...
<div class="equipes view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        <tr>
            <th scope="row"><?= __('ID da Equipe') ?></th>
